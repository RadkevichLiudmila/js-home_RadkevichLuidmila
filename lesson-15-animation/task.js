...
function PlayingBall(Width, Height, PosX, PosY, SpeedX, SpeedY, Id) {
  this.PosX = PosX;
  this.PosY = PosY;
  this.Width = Width;
  this.Height = Height;
...
function Racket(Width, Height, PosX, PosY, SpeedX, SpeedY, Id) {
  this.PosX = PosX;
  this.PosY = PosY;
  this.Width = Width;
  this.Height = Height;
...
let ball = new PlayingBall(sizeBall, sizeBall, fieldWidth / 2 - sizeBall / 2, fieldHeight / 2 - sizeBall / 2, 0, 0, 'ball');
let racket1 = new Racket(racketWidth, racketHeight, 0, fieldHeight / 2 - racketHeight / 2, 0, 0, 'racket1');
let racket2 = new Racket(racketWidth, racketHeight, fieldWidth - racketWidth, fieldHeight / 2 - racketHeight / 2, 0, 0, 'racket2');
...
function Tick() {
  ...
  if ((ball.PosX + ball.Width > playingField.Width - racket2.Width) &&
    (ball.PosY + ball.Height / 2 > racket2.PosY) &&
    (ball.PosY + ball.Height / 2 < racket2.PosY + racket2.Height)) {
    ball.SpeedX = -ball.SpeedX;
    ball.PosX = playingField.Width - ball.Width - racket2.Width;
  } else if (ball.PosX + ball.Width > playingField.Width) { // ограничение справа
    ball.SpeedX = 0;
    ball.SpeedY = 0;
    ball.PosX = playingField.Width - ball.Width;
    goal.player1++;
    goal.Update();
  }
  ...
  // ограничение снизу
  if (ball.PosY + ball.Height > playingField.Height) {
    ball.SpeedY = -ball.SpeedY;
    ball.PosY = playingField.Height - ball.Height;
  }
  ...
  if (racket1.PosY + racket1.Height >  playingField.Height) {
    racket1.SpeedY = 0;
    racket1.PosY = playingField.Height - racket1.Height;
  }
  ...
  if (racket2.PosY + racket2.Height >  playingField.Height) {
    racket2.SpeedY = 0;
    racket2.PosY = playingField.Height - racket2.Height;
  }
